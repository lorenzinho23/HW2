//! REQUISITI PASSWORD (mostra/nascondi box)
function mostraRequisiti(event) {
    ...
    a.src = "../public/foto/nascondi.png";
}
...
//! FUNZIONI PER VERIFICARE I VARI CAMPI DEL FORM
...
function checkCodice(event) {
    ...
    if (!pattern.test(inputCodice.value)) {
        ...
        fetch("register/codice/"+encodeURIComponent(inputCodice.value)).then(fetchResponse).then(jsonCheckCodice);
    }
}
